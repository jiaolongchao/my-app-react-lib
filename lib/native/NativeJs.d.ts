...
export declare class NativeJs {
     ...
     * 获取埋点头
     */
    getRequestHead(callback: any): any;
    getPayRequestHead(callback: any): any;
    /**
     * 拨打电话
     */
     ...
     * 直接调起适当性认证
     */
    startFsp(productId: any, riskScore: any, order_id?: any): void;
    /**
     * 线下支付提示
     */
     ...
     * 调用原生的下拉刷新
     */
    pullRefresh(pullRefresh: any, callback?: Function): void;
    /**
     * 原生页面返回的时候，回调方法
     */
    appBackReload(appBackReload: any, callback?: Function): void;
}
declare let intance: NativeJs;
